...
export default function Card() {
	...
	return (
		<div className="relative">
			<img src={demoBGImg} className="absolute inset-0  object-cover pointer-events-none" alt="Background" />
			<div className="w-106 bg-transparent relative top-[50px] left-[90px] flex flex-col items-center h-[771px] border border-black font-inter">
